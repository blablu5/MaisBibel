...
<template>  
  <main>
    <div class="bg-black min-h-screen">
        <header class="py-5 bg-greenbg bg-bottom pb-12">
            <h1 class="text-white font-bold text-5xl text-center font-fantasy">rekrutier Training</h1>
        </header>
        <div class="pb-5 bg-yellowbg bg-bottom">
          <div class="mx-20 pb-5">
              <h2 class="font-fantasy font-bold text-4xl">Treniere Personen vom Mais-Fanclub zu überzeugen</h2>
